...
#
# Created: Wed Mar 15 15:39:36 2017
...
class Ui_mmqgis_geocode_street_layer_form(object):
    ...
    def retranslateUi(self, mmqgis_geocode_street_layer_form):
        ...
        self.label_20.setText(_translate("mmqgis_geocode_street_layer_form", "Address match quality", None))
        self.nr_allowance.setText(_translate("mmqgis_geocode_street_layer_form", "Allowance for uncoded\n"
"house numbers", None))
        self.aeiou_qual.setItemText(0, _translate("mmqgis_geocode_street_layer_form", "1", None))
        self.aeiou_qual.setItemText(1, _translate("mmqgis_geocode_street_layer_form", "2", None))
        self.aeiou_qual.setItemText(2, _translate("mmqgis_geocode_street_layer_form", "3", None))
        self.aeiou_qual.setItemText(3, _translate("mmqgis_geocode_street_layer_form", "4", None))
        self.aeiou_qual.setItemText(4, _translate("mmqgis_geocode_street_layer_form", "5", None))
        self.zip_allowance.setText(_translate("mmqgis_geocode_street_layer_form", "Allowance for post\n"
"code alterations", None))
